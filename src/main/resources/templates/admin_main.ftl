    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="#" target="_blank" class="logo">
                <span class="logo-lg"><strong>后台管理系统</strong></span>
            </a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="upload/images/${adminAccount.getHead_image()}" class="user-image" alt="User Image">
                                <span class="hidden-xs">${adminAccount.getUsername()}</span>
                            </a>
